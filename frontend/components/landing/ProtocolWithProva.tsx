    ...
    <div className="p-8 md:p-16 lg:p-24 bg-ink relative overflow-hidden h-full">
      ...
      <div className="relative z-10 h-full flex flex-col justify-between">
        <div>
          ...
          <h2 className="font-display font-black text-6xl md:text-8xl mb-12 lg:mb-24 text-white uppercase tracking-[-0.04em] text-right">WITH<br/><span className="text-neon">PROVA</span></h2>
        </div>
